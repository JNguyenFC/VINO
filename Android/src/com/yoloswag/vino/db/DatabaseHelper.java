...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper 
{
	...
	private static final String DATABASE_NAME = "Vino.sqlite";
	...
	public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource)
	{
		...
		// Wine database -- sorted in alphabetical order by winemaker
		...
		Wine cupcake14 = new Wine("Cupcake", "Rose", "Rose", "California", "Sweet", "2000");
	...
	/** Handles upgrade to an existing table
	 */
	@Override
